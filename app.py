...
def main():
    ...
    st.set_page_config(page_title="Sprawdź czy przeżyłbyś katastrofę Tytanica")
    overview = st.container()
    left, right = st.columns(2)
    prediction = st.container()

    st.image("https://www.startpage.com/av/proxy-image?piurl=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.MV75WJWoeBKSBKquHu_wWwHaFR%26pid%3DApi&sp=1699382191T71e11fba26ce36e4392c4fe0ad40bb10ee6908db36081e0b5378340dab23f68d")

    with overview:
        st.title("Sprawdź czy przeżyłbyś katastrofę Tytanica")
